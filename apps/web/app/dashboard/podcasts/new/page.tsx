...
export default function NewPodcastPage() {
  ...
  const nextStep = async () => {
    ...
    if (step === 1) {
      ...
      isValid = await form.trigger(["duration", "title", "hostVoice", "guestVoice", "webhookUrl", "noteId"]);
    }
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="font-serif text-2xl font-medium">Create New Podcast</h1>
                <p className="text-sm text-muted-foreground mt-0.5">
                  Transform your content into an engaging podcast
                </p>
              </div>
            </div>
          </div>
              ...
              <div key={s.id} className="flex items-center">
                <button
                  ...
                  className={cn(
                    ...
                    step === s.id && "border-foreground bg-background",
                    step > s.id && "border-transparent hover:bg-muted/50 cursor-pointer",
                    step < s.id && "border-transparent opacity-50 cursor-not-allowed"
                  )}
                >
                  <div
                    className={cn(
                ...
                <Card className="border-border bg-card">
                  <CardHeader className="pb-4">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Paste your notes, article, or any content to transform into a podcast.
                    </p>
                  </CardHeader>
...
Your content will be transformed into a natural conversation between a host and guest. The AI will analyze your text and create an engaging podcast discussion.
...
• Technical content works great for educational episodes"
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-border">
                      <div className="flex items-center gap-4 text-sm text-muted-foreground">
                        ...
                        <span className={cn(
                          characterCount >= 100 && characterCount <= 10000 && "text-emerald-500",
                          ...
                          <FormItem>
                            <div className="grid grid-cols-3 gap-3">
                              ...
                              >
                                ...
                                <p className="text-xs text-muted-foreground mt-1">Quick overviews</p>
                              </button>
                              ...
                              >
                                ...
                                <p className="font-semibold">Medium · 5-8 min</p>
                                <p className="text-xs text-muted-foreground mt-1">Balanced discussion</p>
                              </button>
                              ...
                              >
                                ...
                                <p className="font-semibold">Long · 8-12 min</p>
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormDescription className="text-xs">
                              If not provided, we'll generate a title based on your content
                            </FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="p-4 rounded-lg border border-border bg-background space-y-3">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm font-medium">Host Voice</span>
                            </div>
                            <Button
                              type="button"
                              variant="ghost"
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                  ...
                                  <SelectContent>
                                    <SelectItem value="default">Default (Warm & Friendly)</SelectItem>
                        ...
                        <div className="p-4 rounded-lg border border-border bg-background space-y-3">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <Volume2 className="h-4 w-4 text-muted-foreground" />
                              <span className="text-sm font-medium">Guest Voice</span>
                            </div>
                            <Button
                              type="button"
                              variant="ghost"
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                  ...
                                  <SelectContent>
                                    <SelectItem value="default">Default (Engaging)</SelectItem>
                      ...
                      <CollapsibleContent className="pt-4 space-y-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 rounded-lg bg-muted/30 border border-border">
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-xs text-muted-foreground">Webhook URL</FormLabel>
                                <FormControl>
                                  <Input
                                    {...field}
                                    type="url"
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                <FormLabel className="text-xs text-muted-foreground">Note ID</FormLabel>
                                <FormControl>
                                  <Input
                                    {...field}
            ...
            {step === 3 && (
              <div className="space-y-8">
                {/* Page Header */}
                <div>
                  <h2 className="font-serif text-2xl lg:text-3xl font-medium">Review & Create</h2>
                    ...
                    <div className="flex items-start gap-8">
                      <div className="flex-1 min-w-0">
                        <p className="text-sm text-muted-foreground leading-relaxed line-clamp-4">
                          {noteContent.substring(0, 400)}{noteContent.length > 400 && "..."}
                        </p>
                      </div>
                      <div className="shrink-0 text-center px-6 py-4 bg-muted/20 rounded-lg border border-border">
                        ...
                        <p className="text-xs text-muted-foreground">{characterCount.toLocaleString()} chars</p>
                      </div>
                    </div>
                  </div>
                </Card>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                      <div>
                        ...
                        <p className="text-lg font-semibold">
                          {duration === "short" ? "Short" : duration === "medium" ? "Medium" : "Long"}
                        </p>
                        <p className="text-sm text-muted-foreground">
                          {duration === "short" ? "3-5 min" : duration === "medium" ? "5-8 min" : "8-12 min"}
                        </p>
                      </div>
                      ...
                      <div>
                        <p className="text-xs text-muted-foreground uppercase tracking-wide mb-2">Host Voice</p>
                      ...
                      <div>
                        <p className="text-xs text-muted-foreground uppercase tracking-wide mb-2">Guest Voice</p>
                        <p className="text-lg font-semibold capitalize">
                          {form.watch("guestVoice")}
                        </p>
                        <p className="text-sm text-muted-foreground">Co-speaker</p>
                      </div>
                    </div>
                  </div>
                </Card>
                ...
                <div className="flex items-center justify-between p-5 rounded-lg border border-emerald-500/20 bg-emerald-500/5">
                  <div className="flex items-center gap-4">
                    ...
                    <p className="text-sm">
                      This will use <span className="text-emerald-500 font-semibold">1 credit</span> from your account
                    </p>
                  </div>
                </div>
